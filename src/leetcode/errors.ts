...
export function toUserMessage(error: unknown): string {
  ...
  switch (error.kind) {
    ...
    case "timeout":
      return "连接 LeetDock 超时，请稍后重试。";
    case "rate-limit":
      return "请求过于频繁，请稍后再试。";
    case "service":
      return "LeetDock 服务暂时不可用，请稍后重试。";
    case "stale-session":
      return "LeetDock 登录状态已发生变化，请重试。";
    case "graphql":
      return "LeetDock 返回了接口错误，请稍后重试。";
    case "not-found":
      return "没有找到对应题目，请检查题号、名称或 URL。";
    case "invalid-response":
      return "LeetDock 返回了无法识别的数据。";
    case "network":
      return "无法连接 LeetDock，请检查网络连接。";
  }
}
